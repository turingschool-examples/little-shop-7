...
describe "Admin Dashboard Index Page" do
  before :each do
    ...
    @t1 = Transaction.create!(invoice_id: @i1.id, credit_card_number: "0000000000000000", credit_card_expiration_date: 1.year.from_now, result: 1)
    @t2 = Transaction.create!(invoice_id: @i2.id, credit_card_number: "0000000000000000", credit_card_expiration_date: 1.year.from_now, result: 1)
    @t3 = Transaction.create!(invoice_id: @i3.id, credit_card_number: "0000000000000000", credit_card_expiration_date: 1.year.from_now, result: 1)
    @t4 = Transaction.create!(invoice_id: @i4.id, credit_card_number: "0000000000000000", credit_card_expiration_date: 1.year.from_now, result: 1)
    @t5 = Transaction.create!(invoice_id: @i5.id, credit_card_number: "0000000000000000", credit_card_expiration_date: 1.year.from_now, result: 1)
