...
RSpec.describe "the admin dashboard show" do
  ...
  #Incomplete Invoices
    ...
    @incomplete_invoice1 = Invoice.create!(customer: @test_customer, status: "in progress")
    InvoiceItem.create!(invoice: @incomplete_invoice1, item: @item, status: "packaged")
    @incomplete_invoice2 = Invoice.create!(customer: @test_customer, status: "in progress")
    InvoiceItem.create!(invoice: @incomplete_invoice2, item: @item, status: "pending")
    @complete_invoice = Invoice.create!(customer: @test_customer, status: "completed")
