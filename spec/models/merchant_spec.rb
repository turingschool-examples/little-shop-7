  ...
  describe "instance methods" do 
    ...
    describe "#favorite_customers" do
      it "returns the top 5 customers with the most successful transactions for a merchant " do
        # expect(@merchant1.favorite_customers_alt).to eq([@customer1, @customer2, @customer3, @customer4, @customer5])
        ...
        expect(@merchant_1.favorite_customers_alt.first.transactions).to eq(6)
        expect(@merchant1_.favorite_customers_alt.first).to eq(@customer_6)
      end
    end
