...
RSpec.describe Customer, type: :model do
  ...
  describe "instance methods" do
    ...
    context "#successful_transaction_count" do
      it "returns the number of successful transactions" do
        expect(customer_1.successful_transaction_count).to eq(1)
        expect(customer_2.successful_transaction_count).to eq(2)
        expect(customer_3.successful_transaction_count).to eq(3)
        expect(customer_4.successful_transaction_count).to eq(4)
        expect(customer_5.successful_transaction_count).to eq(5)
        expect(customer_6.successful_transaction_count).to eq(0)
      end
    end
  end
end